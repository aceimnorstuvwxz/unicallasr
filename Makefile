...
# src/mod/asr_tts/mod_pocketsphinx/Makefile.  Generated from Makefile.in by configure.
...
subdir = src/mod/asr_tts/mod_pocketsphinx
...
mod_pocketsphinx_la_DEPENDENCIES =  \
	$(switch_builddir)/libfreeswitch.la $(POCKETSPHINX_LA) \
	$(SPHINXBASE_LA) $(SPHINXBASE_LA2)
am_mod_pocketsphinx_la_OBJECTS =  \
	mod_pocketsphinx_la-mod_pocketsphinx.lo
mod_pocketsphinx_la_OBJECTS = $(am_mod_pocketsphinx_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 = 
mod_pocketsphinx_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CCLD) \
	$(mod_pocketsphinx_la_CFLAGS) $(CFLAGS) \
	$(mod_pocketsphinx_la_LDFLAGS) $(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(mod_pocketsphinx_la_SOURCES)
DIST_SOURCES = $(mod_pocketsphinx_la_SOURCES)
...
YAML_LIBS = -lyaml 
ZCAT = /bin/gunzip
abs_builddir = /usr/src/freeswitch.git/src/mod/asr_tts/mod_pocketsphinx
abs_srcdir = /usr/src/freeswitch.git/src/mod/asr_tts/mod_pocketsphinx
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/build/modmake.rulesam $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign src/mod/asr_tts/mod_pocketsphinx/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign src/mod/asr_tts/mod_pocketsphinx/Makefile
.PRECIOUS: Makefile
...
mod_pocketsphinx.la: $(mod_pocketsphinx_la_OBJECTS) $(mod_pocketsphinx_la_DEPENDENCIES) $(EXTRA_mod_pocketsphinx_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(mod_pocketsphinx_la_LINK) -rpath $(moddir) $(mod_pocketsphinx_la_OBJECTS) $(mod_pocketsphinx_la_LIBADD) $(LIBS)
...
include ./$(DEPDIR)/mod_pocketsphinx_la-mod_pocketsphinx.Plo
...
mod_pocketsphinx_la-mod_pocketsphinx.lo: mod_pocketsphinx.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mod_pocketsphinx_la_CFLAGS) $(CFLAGS) -MT mod_pocketsphinx_la-mod_pocketsphinx.lo -MD -MP -MF $(DEPDIR)/mod_pocketsphinx_la-mod_pocketsphinx.Tpo -c -o mod_pocketsphinx_la-mod_pocketsphinx.lo `test -f 'mod_pocketsphinx.c' || echo '$(srcdir)/'`mod_pocketsphinx.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/mod_pocketsphinx_la-mod_pocketsphinx.Tpo $(DEPDIR)/mod_pocketsphinx_la-mod_pocketsphinx.Plo
#	$(AM_V_CC)source='mod_pocketsphinx.c' object='mod_pocketsphinx_la-mod_pocketsphinx.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mod_pocketsphinx_la_CFLAGS) $(CFLAGS) -c -o mod_pocketsphinx_la-mod_pocketsphinx.lo `test -f 'mod_pocketsphinx.c' || echo '$(srcdir)/'`mod_pocketsphinx.c
...
install-data-am: install-data-local install-modLTLIBRARIES
